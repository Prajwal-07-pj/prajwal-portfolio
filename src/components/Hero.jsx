...
const Hero = () => {
    ...
    return (<section id="home" className="relative min-h-screen overflow-hidden bg-[#040404] pt-[72px] text-white [background:radial-gradient(circle_at_68%_32%,rgba(38,38,38,0.4),transparent_34%),#040404]">
      ...
      <div className="mx-auto grid min-h-[calc(100vh-72px)] w-[94%] max-w-[1240px] grid-cols-1 items-center gap-8 py-8 lg:grid-cols-[1fr_1.1fr] lg:py-0">
        ...
        <div className="flex h-full items-center justify-center">
          <div className="relative aspect-[4/5] w-[min(92%,760px)] overflow-hidden border-l border-t border-white/10 bg-[linear-gradient(160deg,rgba(8,8,8,0.95),rgba(2,2,2,0.96))] max-lg:w-[min(95%,560px)] max-lg:aspect-[4/4.8]">
            ...
            <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-24 bg-gradient-to-b from-transparent via-[#050505]/85 to-[#060606]" aria-hidden="true"></div>

            <div className="absolute bottom-[18px] left-1/2 z-20 flex h-[44px] w-[27px] -translate-x-1/2 justify-center rounded-[15px] border border-[#ff5f1f] bg-[#040404]/65 pt-2" aria-hidden="true">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-20 bg-gradient-to-b from-transparent via-[#050505] to-[#080808]" aria-hidden="true"></div>
    </section>);
};
export default Hero;
